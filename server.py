...
def main():
    ...
    n = 20  # set the number of states
    m = 20  # set the number of control inputs
    N = 7  # set the horizon length
    T = 7  # set the number of time steps
    server = Server(n, m, N)
    server.Kc = 50;
    server.Kw = 20  # set the number of cold start iterations and warm start iterations
    Kc = server.Kc;
    Kw = server.Kw
    nc = server.nc
    server.m = m
